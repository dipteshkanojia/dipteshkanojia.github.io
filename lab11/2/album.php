            ...
            <div class="row">
            	<div class="col-xs-12 jumbotron well well-lg">
                	...
                	<div class="pull-right">
                		<a href="new_upload.php" class="btn btn-info btn-lg" role="button">Upload New Image</a>
                		<a href="delete.php?&image_id=<?php echo $image_id; ?>" class="btn btn-warning btn-lg" role="button">Delete from DB</a>
         	...
         	<div class="row">
         		...
         		<div class="col-xs-12" style="text-align:center">
		     		<div class="btn-group">
						...
						<a href="album.php?&image_id=1" class="btn btn-lg btn-success" role="button" <?php if($image_id==1) { echo "disabled"; } ?> >  
								<span class="glyphicon glyphicon-fast-backward"></span>&nbsp;First
						</a>
						
						<a href="album.php?&image_id=<?php echo $image_id-1 ?>" class="btn btn-lg btn-warning" role="button" <?php if($image_id==1) { echo "disabled"; } ?> >
								<span class="glyphicon glyphicon-step-backward"></span>&nbsp;Prev  
						</a> 
						<a href="album.php?&image_id=<?php echo $image_id+1 ?>" class="btn btn-lg btn-warning" role="button" <?php if($image_id==$end) { echo "disabled"; } ?> >
								Next&nbsp;<span class="glyphicon glyphicon-step-forward"></span>
						</a>
						<a href="album.php?&image_id=<?php echo $end ?>" class="btn btn-lg btn-success" role="button" <?php if($image_id==$end) { echo "disabled"; } ?>>
